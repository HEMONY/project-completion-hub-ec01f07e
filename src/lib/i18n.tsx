...
export const dict: Dict = {
  ...
  cdd_invalid_file_type: { ar: "يُسمح فقط بملفات PDF أو صور JPG وPNG", en: "Only PDF, JPG, JPEG, and PNG files are allowed" },
  cdd_upload_success: { ar: "تم رفع المستندات بنجاح", en: "Documents uploaded successfully" },
  cdd_upload_error: { ar: "تعذر رفع بعض المستندات", en: "Some documents could not be uploaded" },
  cdd_status_pending: { ar: "قيد المراجعة", en: "Pending" },
  cdd_status_approved: { ar: "معتمد", en: "Approved" },
  cdd_status_rejected: { ar: "مرفوض", en: "Rejected" },
  cdd_rejection_reason: { ar: "سبب الرفض", en: "Rejection reason" },
