...
export const dict: Dict = {
  ...
  // خطوات جديدة
  kyc_step_uaeid:    { ar: "التحقق من الهوية", en: "Identity Verification" },
  kyc_step_analysis: { ar: "التحليل المالي",   en: "Financial Analysis" },
  kyc_step_payment:  { ar: "الدفع",             en: "Payment" },
  status_not_started:{ ar: "لم يبدأ",           en: "NOT STARTED" },
  // KYC Form labels
  kyc_full_name:        { ar: "الاسم الكامل", en: "Full Name" },
  kyc_capital:          { ar: "حصة رأس المال (%)", en: "Capital (%)" },
  kyc_nationality:      { ar: "الجنسية", en: "Nationality" },
  kyc_dob:              { ar: "تاريخ ومكان الميلاد", en: "Date & Place of Birth" },
  kyc_emirates_id:      { ar: "رقم الهوية الإماراتية (15 رقم)", en: "Emirates ID Number (15 digits)" },
  kyc_address:          { ar: "عنوان السكن", en: "Residential Address" },
  kyc_upload_id:        { ar: "رفع الهوية الإماراتية *", en: "Upload Emirates ID *" },
  kyc_upload_passport:  { ar: "رفع جواز السفر *", en: "Upload Passport *" },
  kyc_verify_btn:       { ar: "التحقق من الاسم في الهوية", en: "Verify Name against ID" },
  kyc_verifying:        { ar: "جارٍ التحقق...", en: "Verifying..." },
  kyc_name_match:       { ar: "الاسم متطابق مع الهوية", en: "Name matches ID" },
  kyc_name_mismatch:    { ar: "عدم تطابق الاسم — لا يمكن المتابعة", en: "Name Mismatch — Cannot Proceed" },
  kyc_pep_download:     { ar: "تحميل نموذج إقرار الشخص السياسي", en: "Download PEP Declaration Template" },
};
